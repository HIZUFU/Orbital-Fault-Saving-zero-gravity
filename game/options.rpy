...
define config.name = _("Orbital Fault Saving zero gravity")
...
define build.name = "OrbitalFaultSavingzerogravity"
...
define config.save_directory = "OrbitalFaultSavingzerogravity-1711022995"
